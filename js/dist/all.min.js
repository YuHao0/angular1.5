...
!function(t){t.controller("mainController",["$scope","$rootScope","$state",function(t,e,n){var o=this;o.msg="hello",o.menu=[{parent:"test",name:"test.test1"},{parent:"test",name:"test.test2"},{parent:"hi",name:"hi.test1"},{parent:"hi",name:"hi.test2"}],o.stateGo=function(){console.log(n.current)},function(){console.log("init")}()}])}(angular.module("app",["ui.router","oc.lazyLoad"]));
!function(t){t.config(["$stateProvider","$urlRouterProvider","$ocLazyLoadProvider","$httpProvider","$locationProvider",function(t,e,s,l,o){var r={version:"?v=0.1.1",apps:[{name:"test",minUrl:"./js/dist/test.js"},{name:"hi",minUrl:"./js/dist/hi.js"}],lazyLoadModules:[]};angular.forEach(r.apps,function(t){t.serie=!0,t.files=[],t.files.push(t.minUrl+r.version),r.lazyLoadModules.push(t)}),s.config({debug:!1,modules:r.lazyLoadModules}),t.state("test",{"abstract":!0,url:"/test",templateUrl:"views/core/main.html",resolve:{loadApp:["$ocLazyLoad",function(t){return t.load("test")}]}}).state("test.test1",{url:"/test1",templateUrl:"views/app/test/test1.html",controller:"test.test1Controller"}).state("test.test2",{url:"/test2",templateUrl:"views/app/test/test2.html",controller:"test.test2Controller"}).state("hi",{"abstract":!0,url:"/hi",templateUrl:"views/core/main.html",resolve:{loadApp:["$ocLazyLoad",function(t){return t.load("hi")}]}}).state("hi.test1",{url:"/test1",templateUrl:"views/app/hi/test1.html",controller:"hi.test1Controller"}).state("hi.test2",{url:"/test2",templateUrl:"views/app/hi/test2.html",controller:"hi.test2Controller"}),e.otherwise("/hi/test1")}]),t.run(["$rootScope","$state","$ocLazyLoad",function(t,e,s){t.$state=e}])}(angular.module("app"));