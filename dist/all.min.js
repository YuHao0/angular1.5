...
!function(t){t.config(["$stateProvider","$urlRouterProvider","$ocLazyLoadProvider","$httpProvider","$locationProvider",function(t,e,o,r,a){var s=Duoshou.config;angular.forEach(s.apps,function(t){t.serie=!0,t.files=[],t.files.push("/dist/"+t.name+".js"+s.version),s.lazyLoadModules.push(t)}),o.config({debug:!1,modules:s.lazyLoadModules}),function(){t.state("test",{"abstract":!0,url:"/test",templateUrl:"/views/core/main.html",resolve:{loadApp:["$ocLazyLoad",function(t){return t.load("test")}]}}).state("test.test1",{url:"/test1",templateUrl:"/views/app/test/test1.html",controller:"test.test1Controller"}).state("test.test2",{url:"/test2",templateUrl:"/views/app/test/test2.html",controller:"test.test2Controller"}).state("hi",{"abstract":!0,url:"/hi",templateUrl:"/views/core/main.html",resolve:{loadApp:["$ocLazyLoad",function(t){return t.load("hi")}]}}).state("hi.test1",{url:"/test1",templateUrl:"/views/app/hi/test1.html",controller:"hi.test1Controller"}).state("hi.test2",{url:"/test2",templateUrl:"/views/app/hi/test2.html",controller:"hi.test2Controller"}),e.otherwise("/hi/test1")}(),r.interceptors.push(["$q","tips","viewMask",function(t,e,o){return{request:function(t){var e=function(e){return angular.forEach(["autoMask","autoTips"],function(o){t[o]=void 0===e[o]||e[o],delete e[o]}),e};return t.url&&~t.url.indexOf("h5api")&&t.method&&(console.log(t),"GET"===t.method.toUpperCase()?t.params=e(t.params||{}):(t.data=e(t.data||{}),t.headers["Content-Type"]="application/x-www-form-urlencoded;charset=utf-8",t.transformRequest=[function(t){return angular.isObject(t)?$.param(angular.forEach(t=angular.copy(t),function(e,o){t[o]=angular.isArray(e)||angular.isObject(e)?JSON.stringify(e):e})):t}]),t.autoMask&&o.open(),t.url=decodeURIComponent(t.url)),t},requestError:function(e){return t.reject(e)},response:function(t){return console.log(t),t.config&&(t.config.autoMask&&o.close(),t.data.message&&t.config.autoTips&&e.success(t.data.message)),t},responseError:function(r){return r.config&&(r.config.autoMask&&o.close(),r.data&&r.data.message&&r.config.autoTips&&!$(".messenger-message-inner").length&&e.error(r.data.message)),r.data&&""==r.data.code&&(location.href="/login?go="+encodeURIComponent(location.href)),t.reject(r)}}}])}]),t.run(["$rootScope","$state","$api",function(t,e,o){t.$state=e,o.$apply(Duoshou.service)}])}(angular.module("app",["ui.router","oc.lazyLoad","ngResource"]));
!function(t){t.service("$api",["$resource",function(t){var n=function(t){return/(^http:\/\/)|(^https:\/\/)|(^\/)/.test(t)?t:location.protocol+"//"+location.host+"/"+t};this.$apply=function(i){return angular.forEach(i,function(i,o){var a=i[0],l=i[1]||{method:"GET"};this[o]=t(n(a),{},{getData:l}).getData},this),this}}]),t.service("viewMask",function(){~function(t,n){t.open=t.show=function(i){t.loading=t.loading||0,n.call(t,i,!0)},t.close=t.hide=function(i,o){i instanceof Function||(i=null,o=arguments[0]),t.loading=t.loading||0,n.call(t,i,!1,o)}}(this,function(t,n,i){n?this.loading++:i?this.loading=0:this.loading--,this.loading?$("#viewMask").attr("style","display:block"):$("#viewMask").attr("style","display:none"),setTimeout(t||angular.noop,0)})})}(angular.module("app"));
!function(e){e.controller("mainController",["$scope","$rootScope","$state","$api","$q","tips",function(e,t,n,o,a,i){var s=this;s.msg="hello",s.menu=[{name:"test",nav:[{name:"test.test1"},{name:"test.test2"}]},{name:"hi",nav:[{name:"hi.test1"},{name:"hi.test2"}]}],s.stateGo=function(){console.log(n.current)},function(){console.log("init"),console.log(o)}(),i.error("ok",5e4),o.index_tab({apiv:9}),o.active({apiv:3,limit:999,page:1,token:"ARg9weCtTS2qRjE7KeegH4M"})}])}(angular.module("app"));
!function(t){var e={tips:function(){Messenger.options={extraClasses:"messenger-fixed messenger-on-top",theme:"air"};var t=Messenger(),e={success:{type:"success",hideAfter:3},error:{type:"success",showCloseButton:!0}},s={};return angular.forEach(e,function(e,o){s[o]=function(s,o){o&&(e.hideAfter=o),e.message=s,t.post(e)}}),s}};t.factory("tips",e.tips)}(angular.module("app")),+function(t){"use strict";function e(e,o){return this.each(function(){var i=t(this),n=i.data("bs.modal"),a=t.extend({},s.DEFAULTS,i.data(),"object"==typeof e&&e);n||i.data("bs.modal",n=new s(this,a)),"string"==typeof e?n[e](o):a.show&&n.show(o)})}var s=function(e,s){this.options=s,this.$body=t(document.body),this.$element=t(e),this.$dialog=this.$element.find(".modal-dialog"),this.$backdrop=null,this.isShown=null,this.originalBodyPad=null,this.scrollbarWidth=0,this.ignoreBackdropClick=!1,this.options.remote&&this.$element.find(".modal-content").load(this.options.remote,t.proxy(function(){this.$element.trigger("loaded.bs.modal")},this))};s.VERSION="3.3.7",s.TRANSITION_DURATION=300,s.BACKDROP_TRANSITION_DURATION=150,s.DEFAULTS={backdrop:!0,keyboard:!0,show:!0},s.prototype.toggle=function(t){return this.isShown?this.hide():this.show(t)},s.prototype.show=function(e){var o=this,i=t.Event("show.bs.modal",{relatedTarget:e});this.$element.trigger(i),this.isShown||i.isDefaultPrevented()||(this.isShown=!0,this.checkScrollbar(),this.setScrollbar(),this.$body.addClass("modal-open"),this.escape(),this.resize(),this.$element.on("click.dismiss.bs.modal",'[data-dismiss="modal"]',t.proxy(this.hide,this)),this.$dialog.on("mousedown.dismiss.bs.modal",function(){o.$element.one("mouseup.dismiss.bs.modal",function(e){t(e.target).is(o.$element)&&(o.ignoreBackdropClick=!0)})}),this.backdrop(function(){var i=t.support.transition&&o.$element.hasClass("fade");o.$element.parent().length||o.$element.appendTo(o.$body),o.$element.show().scrollTop(0),o.adjustDialog(),i&&o.$element[0].offsetWidth,o.$element.addClass("in"),o.enforceFocus();var n=t.Event("shown.bs.modal",{relatedTarget:e});i?o.$dialog.one("bsTransitionEnd",function(){o.$element.trigger("focus").trigger(n)}).emulateTransitionEnd(s.TRANSITION_DURATION):o.$element.trigger("focus").trigger(n)}))},s.prototype.hide=function(e){e&&e.preventDefault(),e=t.Event("hide.bs.modal"),this.$element.trigger(e),this.isShown&&!e.isDefaultPrevented()&&(this.isShown=!1,this.escape(),this.resize(),t(document).off("focusin.bs.modal"),this.$element.removeClass("in").off("click.dismiss.bs.modal").off("mouseup.dismiss.bs.modal"),this.$dialog.off("mousedown.dismiss.bs.modal"),t.support.transition&&this.$element.hasClass("fade")?this.$element.one("bsTransitionEnd",t.proxy(this.hideModal,this)).emulateTransitionEnd(s.TRANSITION_DURATION):this.hideModal())},s.prototype.enforceFocus=function(){t(document).off("focusin.bs.modal").on("focusin.bs.modal",t.proxy(function(t){document===t.target||this.$element[0]===t.target||this.$element.has(t.target).length||this.$element.trigger("focus")},this))},s.prototype.escape=function(){this.isShown&&this.options.keyboard?this.$element.on("keydown.dismiss.bs.modal",t.proxy(function(t){27==t.which&&this.hide()},this)):this.isShown||this.$element.off("keydown.dismiss.bs.modal")},s.prototype.resize=function(){this.isShown?t(window).on("resize.bs.modal",t.proxy(this.handleUpdate,this)):t(window).off("resize.bs.modal")},s.prototype.hideModal=function(){var t=this;this.$element.hide(),this.backdrop(function(){t.$body.removeClass("modal-open"),t.resetAdjustments(),t.resetScrollbar(),t.$element.trigger("hidden.bs.modal")})},s.prototype.removeBackdrop=function(){this.$backdrop&&this.$backdrop.remove(),this.$backdrop=null},s.prototype.backdrop=function(e){var o=this,i=this.$element.hasClass("fade")?"fade":"";if(this.isShown&&this.options.backdrop){var n=t.support.transition&&i;if(this.$backdrop=t(document.createElement("div")).addClass("modal-backdrop "+i).appendTo(this.$body),this.$element.on("click.dismiss.bs.modal",t.proxy(function(t){return this.ignoreBackdropClick?void(this.ignoreBackdropClick=!1):void(t.target===t.currentTarget&&("static"==this.options.backdrop?this.$element[0].focus():this.hide()))},this)),n&&this.$backdrop[0].offsetWidth,this.$backdrop.addClass("in"),!e)return;n?this.$backdrop.one("bsTransitionEnd",e).emulateTransitionEnd(s.BACKDROP_TRANSITION_DURATION):e()}else if(!this.isShown&&this.$backdrop){this.$backdrop.removeClass("in");var a=function(){o.removeBackdrop(),e&&e()};t.support.transition&&this.$element.hasClass("fade")?this.$backdrop.one("bsTransitionEnd",a).emulateTransitionEnd(s.BACKDROP_TRANSITION_DURATION):a()}else e&&e()},s.prototype.handleUpdate=function(){this.adjustDialog()},s.prototype.adjustDialog=function(){var t=this.$element[0].scrollHeight>document.documentElement.clientHeight;this.$element.css({paddingLeft:!this.bodyIsOverflowing&&t?this.scrollbarWidth:"",paddingRight:this.bodyIsOverflowing&&!t?this.scrollbarWidth:""})},s.prototype.resetAdjustments=function(){this.$element.css({paddingLeft:"",paddingRight:""})},s.prototype.checkScrollbar=function(){var t=window.innerWidth;if(!t){var e=document.documentElement.getBoundingClientRect();t=e.right-Math.abs(e.left)}this.bodyIsOverflowing=document.body.clientWidth<t,this.scrollbarWidth=this.measureScrollbar()},s.prototype.setScrollbar=function(){var t=parseInt(this.$body.css("padding-right")||0,10);this.originalBodyPad=document.body.style.paddingRight||"",this.bodyIsOverflowing&&this.$body.css("padding-right",t+this.scrollbarWidth)},s.prototype.resetScrollbar=function(){this.$body.css("padding-right",this.originalBodyPad)},s.prototype.measureScrollbar=function(){var t=document.createElement("div");t.className="modal-scrollbar-measure",this.$body.append(t);var e=t.offsetWidth-t.clientWidth;return this.$body[0].removeChild(t),e};var o=t.fn.modal;t.fn.modal=e,t.fn.modal.Constructor=s,t.fn.modal.noConflict=function(){return t.fn.modal=o,this},t(document).on("click.bs.modal.data-api",'[data-toggle="modal"]',function(s){var o=t(this),i=o.attr("href"),n=t(o.attr("data-target")||i&&i.replace(/.*(?=#[^\s]+$)/,"")),a=n.data("bs.modal")?"toggle":t.extend({remote:!/#/.test(i)&&i},n.data(),o.data());o.is("a")&&s.preventDefault(),n.one("show.bs.modal",function(t){t.isDefaultPrevented()||n.one("hidden.bs.modal",function(){o.is(":visible")&&o.trigger("focus")})}),e.call(n,a,this)})}(jQuery);