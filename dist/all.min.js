...
window.Duoshou={config:{localTest:!1,version:"?v=0.1.2",lazyLoadModules:[],apps:[{name:"test"},{name:"hi"}]}};
Duoshou.service={index_tab:["https://h5api.zhefengle.cn/index/index_tab.html",{method:"POST"}],active:["https://h5api.zhefengle.cn/activity/official/activity_official_list.html"]};
!function(t){t.config(["$stateProvider","$urlRouterProvider","$ocLazyLoadProvider","$httpProvider","$provide",function(t,e,a,o,n){var r=Duoshou.config;angular.forEach(r.apps,function(t){t.serie=!0,t.files=[],t.files.push("/dist/"+t.name+".js"+r.version),r.lazyLoadModules.push(t)}),a.config({debug:!1,modules:r.lazyLoadModules}),o.interceptors.push(["$q","tips","viewMask",function(t,e,a){return{request:function(t){var e=function(e){return angular.forEach(["autoMask","autoTips"],function(a){t[a]=void 0===e[a]||e[a],delete e[a]}),e};return t.url&&~t.url.indexOf("h5api")&&t.method&&("GET"===t.method.toUpperCase()?t.params=e(t.params||{}):(t.data=e(t.data||{}),t.headers["Content-Type"]="application/x-www-form-urlencoded;charset=utf-8",t.transformRequest=[function(t){return angular.isObject(t)?$.param(angular.forEach(t=angular.copy(t),function(e,a){t[a]=angular.isArray(e)||angular.isObject(e)?JSON.stringify(e):e})):t}]),t.autoMask&&a.open(),t.url=decodeURIComponent(t.url)),t},requestError:function(e){return t.reject(e)},response:function(t){return t.config&&(t.config.autoMask&&a.close(),t.data.message&&t.config.autoTips&&e.success(t.data.message)),t},responseError:function(o){return o.config&&(o.config.autoMask&&a.close(),o.data&&o.data.message&&o.config.autoTips&&!$(".messenger-message-inner").length&&e.error(o.data.message)),o.data&&""==o.data.code&&(location.href="/login?go="+encodeURIComponent(location.href)),t.reject(o)}}}]),function(){n.service("$api",["$resource",function(t){var e=function(t){return/(^http:\/\/)|(^https:\/\/)|(^\/)/.test(t)?t:location.protocol+"//"+location.host+"/"+t};this.$apply=function(a){return angular.forEach(a,function(a,o){var n=a[0],r=a[1]||{method:"GET"};this[o]=t(e(n),{},{getData:r}).getData},this),this}}]),n.service("viewMask",function(){~function(t,e){t.open=t.show=function(a){t.loading=t.loading||0,e.call(t,a,!0)},t.close=t.hide=function(a,o){a instanceof Function||(a=null,o=arguments[0]),t.loading=t.loading||0,e.call(t,a,!1,o)}}(this,function(t,e,a){var o=this;e?o.loading++:a?o.loading=0:o.loading--,o.loading?$("#viewMask").attr("style","display:block"):$("#viewMask").attr("style","display:none"),setTimeout(t||angular.noop,0)})})}(),function(){t.state("test",{"abstract":!0,url:"/test",templateUrl:"/views/core/main.html",resolve:{loadApp:["$ocLazyLoad",function(t){return t.load("test")}]}}).state("test.test1",{url:"/test1",templateUrl:"/views/app/test/test1.html"}).state("test.test2",{url:"/test2",templateUrl:"/views/app/test/test2.html"}).state("hi",{"abstract":!0,url:"/hi",templateUrl:"/views/core/main.html",resolve:{loadApp:["$ocLazyLoad",function(t){return t.load("hi")}]}}).state("hi.test1",{url:"/test1",templateUrl:"/views/app/hi/test1.html"}).state("hi.test2",{url:"/test2",templateUrl:"/views/app/hi/test2.html"}),e.otherwise("/hi/test1")}()}]),t.run(["$rootScope","$state","$api",function(t,e,a){t.$state=e,a.$apply(Duoshou.service)}])}(angular.module("app",["ui.router","oc.lazyLoad","ngResource"]));
!function(t){var i={tips:function(){Messenger.options={extraClasses:"messenger-fixed messenger-on-top",theme:"air"};var t=Messenger(),i={success:{type:"success",hideAfter:3},error:{type:"error",showCloseButton:!0}},e={};return angular.forEach(i,function(i,s){e[s]=function(e,s){s&&(i.hideAfter=s),i.message=e,t.post(i)}}),e},dealPage:function(t,i){return function(e,s){if(!e)return null;var n=function(t,i,e){return e=e||(t>i?t%i:0),Math.max(1,(t-e)/i+(e?1:0))};return angular.extend([],angular.extend({limit:15,total:0,split:5,index:e.page||1,selected:e.page||1,popover:!1,prevName:"上一页",nextName:"下一页",click:function(t){if("object"==typeof t){if(t.index==this.index)return this;t.prev||t.next?this.index+=t.prev?-1:1:t.first||t.last?this.index=t.first?1:this.nums:this.index=t.index}else{if(!/^[0-9]*$/.test(Math.abs(parseInt(t))))return this;if((t=parseInt(t))===this.index)return this;this.index=t}return(t=this.apply()).index&&angular.forEach(this.callback,function(e){e instanceof Function&&i(function(){angular.forEach("index|selected|page|limit|split".split("|"),function(i){t[i]=Math.max(parseInt(t[i]||1),1)}),e(t)},10)}),this.loading=t.index,this},apply:function(){var i=this;this.nums||(this.nums=n(this.total,this.limit),this.rows=n(this.nums,this.split),this.callback=this.callback?this.callback instanceof Array?this.callback:[this.callback]:[],s instanceof Array?this.callback=this.callback.concat(s):s&&this.callback.push(s)),this.index=this.selected=this.page=Math.max(1,Math.min(this.index,this.nums)),this.row=Math.min(n(this.index,this.split),this.rows),this.splice(0),this.index>1&&(this[0]={index:this.prevName,selected:this.index-1,prev:!0}),this.row>1&&(this[1]={index:"1...",selected:1,first:!0});for(var e=(this.row-1)*this.split+1;e<=Math.min(this.row*this.split,this.nums);e++)this[this.length]={index:e,selected:e,num:!0,active:this.index===e};return this.row<this.rows&&(this[this.length]={index:"..."+this.nums,selected:this.nums,last:!0}),this.index<this.nums&&(this[this.length]={index:this.nextName,selected:this.index+1,next:!0}),angular.forEach(i,function(i){i.index=t.trustAsHtml(i.index.toString())}),this}},e)).apply()}}};t.factory("tips",i.tips),t.factory("pager",["$sce","$timeout",i.dealPage]),t.directive("datetimepicker",["$parse","$q","$timeout","$ocLazyLoad",function(t,i,e,s){return{restrict:"A",require:"?ngModel",link:function(t,i,e,n){s.load(["../../lib/datetimepicker/datetimepicker.css","../../lib/datetimepicker/bootstrap-datetimepicker.min.js"]).then(function(){$.fn.datetimepicker.dates["zh-CN"]={days:["星期日","星期一","星期二","星期三","星期四","星期五","星期六","星期日"],daysShort:["周日","周一","周二","周三","周四","周五","周六","周日"],daysMin:["日","一","二","三","四","五","六","日"],months:["一月","二月","三月","四月","五月","六月","七月","八月","九月","十月","十一月","十二月"],monthsShort:["一月","二月","三月","四月","五月","六月","七月","八月","九月","十月","十一月","十二月"],today:"今天",suffix:[],meridiem:["上午","下午"]};var t=$(i).datetimepicker({autoclose:!0,format:i.attr("data-format")||"yyyy-mm-dd HH:ii:00",language:"zh-CN",pickerPosition:"bottom-right",minView:e.minview||0,viewSelect:"year"}),s=t.data("datetimepicker").picker;s.find(".icon-arrow-left").replaceWith('<i class="dsb-font dsb-left"></i>'),s.find(".icon-arrow-right").replaceWith('<i class="dsb-font dsb-right"></i>')})}}}]),t.directive("pagination",["$compile","$timeout",function(t,i){return{restrict:"A",require:"?ngModel",template:function(t,i){if(i.pagination){var e=[],s=i.pagination,n=[];n.push(s+".limit!=="+s+".pageSize"),n.push("&&("+s+".limit="+s+".pageSize)"),n.push("&&"+s+".click(-1)"),e.push('<ul ng-show="'+s+'.total">'),e.push('<li ng-repeat="page in '+s+'" ng-class="{true:\' active\'}[page.active]" ng-click="'+s+'.click(page)">'),e.push('<a href="javascript:void(0)" ng-bind-html="page.index"></a>'),e.push("</li>"),e.push('<li ng-show="'+s+'.total">'),e.push('<span class="click-popover">'),e.push('<div ng-show="'+s+'.popover" class="input-append"><input type="text" ng-keydown="$event.keyCode===13&&'+n.join("")+'" ng-model="'+s+'.pageSize"/><a href="javascript:void(0)" ng-click="'+n.join("")+'"><i class="dsb-font dsb-ok"></i></a></div>'),e.push('每页<b class="text-info" ng-bind="'+s+'.limit"></b> '),e.push('<a href="javascript:void(0)" ng-click="'+s+".popover=true;"+s+".pageSize="+s+'.limit"><i class="dsb-font dsb-gear"></i></a>'),e.push("</span>"),e.push("</li>"),e.push('<li ng-if="'+s+'.total" class="total-count"><span>总计<b class="text-info" ng-bind="'+s+'.total"></b></span></li>'),e.push("</ul>"),e.push('<span ng-if="'+s+'.rows>1" class="jump-page"><input type="text" class="input-small text-right" ng-keydown="$event.keyCode===13&&'+s+".click("+s+'.selected)" ng-model="'+s+'.selected"/>'),e.push('<a ng-if="'+s+'.rows>1" href="javascript:void(0)" ng-click="'+s+".click("+s+'.selected)"><i class="dsb-font dsb-right"></i></a>'),e.push("</span>"),t.addClass("pagination").html(e.join(""))}},link:function(t,i,e){if(e.pagination){var s=e.pagination,n=function(){t[s]&&(t[s].popover=!1,t.$apply(t[s].popover))};$(".click-popover").click(function(t){t.stopPropagation()}),$(document).click(n)}}}}]),t.directive("table",["$compile","$timeout",function(t,i){return{restrict:"E",require:"?ngModel",link:function(t,i,e){function s(t){return o.html(t),o.css("font-size",14),o.width()+15}var n="",o=$("#dvCompute");i.off().on("mouseover",function(t){n=t.target,"TD"==n.nodeName&&s(n.innerHTML)>n.offsetWidth&&!~n.innerHTML.indexOf("<a")?o.css({top:t.pageY,left:t.pageX,"font-size":12}):o.css("top",1e4)})}}}])}(angular.module("app")),+function(t){"use strict";function i(i,s){return this.each(function(){var n=t(this),o=n.data("bs.modal"),a=t.extend({},e.DEFAULTS,n.data(),"object"==typeof i&&i);o||n.data("bs.modal",o=new e(this,a)),"string"==typeof i?o[i](s):a.show&&o.show(s)})}var e=function(i,e){this.options=e,this.$body=t(document.body),this.$element=t(i),this.$dialog=this.$element.find(".modal-dialog"),this.$backdrop=null,this.isShown=null,this.originalBodyPad=null,this.scrollbarWidth=0,this.ignoreBackdropClick=!1,this.options.remote&&this.$element.find(".modal-content").load(this.options.remote,t.proxy(function(){this.$element.trigger("loaded.bs.modal")},this))};e.VERSION="3.3.7",e.TRANSITION_DURATION=300,e.BACKDROP_TRANSITION_DURATION=150,e.DEFAULTS={backdrop:!0,keyboard:!0,show:!0},e.prototype.toggle=function(t){return this.isShown?this.hide():this.show(t)},e.prototype.show=function(i){var s=this,n=t.Event("show.bs.modal",{relatedTarget:i});this.$element.trigger(n),this.isShown||n.isDefaultPrevented()||(this.isShown=!0,this.checkScrollbar(),this.setScrollbar(),this.$body.addClass("modal-open"),this.escape(),this.resize(),this.$element.on("click.dismiss.bs.modal",'[data-dismiss="modal"]',t.proxy(this.hide,this)),this.$dialog.on("mousedown.dismiss.bs.modal",function(){s.$element.one("mouseup.dismiss.bs.modal",function(i){t(i.target).is(s.$element)&&(s.ignoreBackdropClick=!0)})}),this.backdrop(function(){var n=t.support.transition&&s.$element.hasClass("fade");s.$element.parent().length||s.$element.appendTo(s.$body),s.$element.show().scrollTop(0),s.adjustDialog(),n&&s.$element[0].offsetWidth,s.$element.addClass("in"),s.enforceFocus();var o=t.Event("shown.bs.modal",{relatedTarget:i});n?s.$dialog.one("bsTransitionEnd",function(){s.$element.trigger("focus").trigger(o)}).emulateTransitionEnd(e.TRANSITION_DURATION):s.$element.trigger("focus").trigger(o)}))},e.prototype.hide=function(i){i&&i.preventDefault(),i=t.Event("hide.bs.modal"),this.$element.trigger(i),this.isShown&&!i.isDefaultPrevented()&&(this.isShown=!1,this.escape(),this.resize(),t(document).off("focusin.bs.modal"),this.$element.removeClass("in").off("click.dismiss.bs.modal").off("mouseup.dismiss.bs.modal"),this.$dialog.off("mousedown.dismiss.bs.modal"),t.support.transition&&this.$element.hasClass("fade")?this.$element.one("bsTransitionEnd",t.proxy(this.hideModal,this)).emulateTransitionEnd(e.TRANSITION_DURATION):this.hideModal())},e.prototype.enforceFocus=function(){t(document).off("focusin.bs.modal").on("focusin.bs.modal",t.proxy(function(t){document===t.target||this.$element[0]===t.target||this.$element.has(t.target).length||this.$element.trigger("focus")},this))},e.prototype.escape=function(){this.isShown&&this.options.keyboard?this.$element.on("keydown.dismiss.bs.modal",t.proxy(function(t){27==t.which&&this.hide()},this)):this.isShown||this.$element.off("keydown.dismiss.bs.modal")},e.prototype.resize=function(){this.isShown?t(window).on("resize.bs.modal",t.proxy(this.handleUpdate,this)):t(window).off("resize.bs.modal")},e.prototype.hideModal=function(){var t=this;this.$element.hide(),this.backdrop(function(){t.$body.removeClass("modal-open"),t.resetAdjustments(),t.resetScrollbar(),t.$element.trigger("hidden.bs.modal")})},e.prototype.removeBackdrop=function(){this.$backdrop&&this.$backdrop.remove(),this.$backdrop=null},e.prototype.backdrop=function(i){var s=this,n=this.$element.hasClass("fade")?"fade":"";if(this.isShown&&this.options.backdrop){var o=t.support.transition&&n;if(this.$backdrop=t(document.createElement("div")).addClass("modal-backdrop "+n).appendTo(this.$body),this.$element.on("click.dismiss.bs.modal",t.proxy(function(t){return this.ignoreBackdropClick?void(this.ignoreBackdropClick=!1):void(t.target===t.currentTarget&&("static"==this.options.backdrop?this.$element[0].focus():this.hide()))},this)),o&&this.$backdrop[0].offsetWidth,this.$backdrop.addClass("in"),!i)return;o?this.$backdrop.one("bsTransitionEnd",i).emulateTransitionEnd(e.BACKDROP_TRANSITION_DURATION):i()}else if(!this.isShown&&this.$backdrop){this.$backdrop.removeClass("in");var a=function(){s.removeBackdrop(),i&&i()};t.support.transition&&this.$element.hasClass("fade")?this.$backdrop.one("bsTransitionEnd",a).emulateTransitionEnd(e.BACKDROP_TRANSITION_DURATION):a()}else i&&i()},e.prototype.handleUpdate=function(){this.adjustDialog()},e.prototype.adjustDialog=function(){var t=this.$element[0].scrollHeight>document.documentElement.clientHeight;this.$element.css({paddingLeft:!this.bodyIsOverflowing&&t?this.scrollbarWidth:"",paddingRight:this.bodyIsOverflowing&&!t?this.scrollbarWidth:""})},e.prototype.resetAdjustments=function(){this.$element.css({paddingLeft:"",paddingRight:""})},e.prototype.checkScrollbar=function(){var t=window.innerWidth;if(!t){var i=document.documentElement.getBoundingClientRect();t=i.right-Math.abs(i.left)}this.bodyIsOverflowing=document.body.clientWidth<t,this.scrollbarWidth=this.measureScrollbar()},e.prototype.setScrollbar=function(){var t=parseInt(this.$body.css("padding-right")||0,10);this.originalBodyPad=document.body.style.paddingRight||"",this.bodyIsOverflowing&&this.$body.css("padding-right",t+this.scrollbarWidth)},e.prototype.resetScrollbar=function(){this.$body.css("padding-right",this.originalBodyPad)},e.prototype.measureScrollbar=function(){var t=document.createElement("div");t.className="modal-scrollbar-measure",this.$body.append(t);var i=t.offsetWidth-t.clientWidth;return this.$body[0].removeChild(t),i};var s=t.fn.modal;t.fn.modal=i,t.fn.modal.Constructor=e,t.fn.modal.noConflict=function(){return t.fn.modal=s,this},t(document).on("click.bs.modal.data-api",'[data-toggle="modal"]',function(e){var s=t(this),n=s.attr("href"),o=t(s.attr("data-target")||n&&n.replace(/.*(?=#[^\s]+$)/,"")),a=o.data("bs.modal")?"toggle":t.extend({},o.data(),s.data());s.is("a")&&e.preventDefault(),o.one("show.bs.modal",function(t){t.isDefaultPrevented()||o.one("hidden.bs.modal",function(){s.is(":visible")&&s.trigger("focus")})}),i.call(o,a,this)})}(jQuery);
!function(t){t.controller("mainController",["$scope","$rootScope","$state","$api","$q","tips",function(t,e,n,o,a,s){var i=this;i.msg="hello",i.menu=[{name:"test",nav:[{name:"test.test1"},{name:"test.test2"}]},{name:"hi",nav:[{name:"hi.test1"},{name:"hi.test2"}]}],i.stateGo=function(){console.log(n.current)}}])}(angular.module("app"));